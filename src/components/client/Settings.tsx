...
import { header, meta, globalConfig } from '@k4itrun/config';
                            ...
                            <div className="mt-8">
                                ...
                                <div className="flex items-center gap-4">
                                    {socials?.map((social, index) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                {IconComponent ? (
                                                    <IconComponent className="w-6 h-6 fill-neutral-700/50 hover:fill-neutral-700 dark:fill-white/50 dark:hover:fill-white transition-all duration-200" />
                                                ) : (
                                                    <Icons.XIcon className="w-6 h-6 text-red-700/70 hover:text-red-700" />
                                                )}
                                            </Link>
                                        );
                                    })}
                                    <Button
                                        variant="tertiary"
                                        href="/discord"
                                        className="flex w-full gap-2 px-4 h-11 ml-auto justify-between"
                                    >
                                        <div className="flex items-center gap-2">
                                ...
                                <div className="flex justify-end">
                                    <Button
                                        ...
                                        className="mt-6 flex items-center h-11 gap-1 ml-auto justify-between bg-color-layout hover:bg-color-layout"
                                    >
                                        <div className="flex items-center gap-2">
