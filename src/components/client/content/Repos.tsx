...
import { toImgB64 } from '@k4itrun/utils';
...
export const Repos = () => {
    const { data: _repositories } = useSWR<Repository[]>("/api/repos");
                                ...
                                repositories
                                    ...
                                    .map((repo, index) => (
                                        ...
                                        >
                                            <img
                                                alt={repo.full_name}
                                                src={toImgB64(`https://opengraph.githubassets.com/HEAD/${repo.full_name}`)}
                                                width="1024"
